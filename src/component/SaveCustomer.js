...
function SaveCustomer(){
    ...
    const [cRegisteredOn, setCRegisteredOn] = useState("");
    ...
    return (<div id='bg'>
            ...
            <tr>
                <td>RegisteredOn</td>
                <td><input type="date" name="cRegisteredOn" value ={cRegisteredOn} className ="form-control" id="cRegisteredOn"
                 onChange={(event)=> setCRegisteredOn(event.target.value)}/></td>
            </tr>
            <tr>
                <td>Address</td>
        ...
        <br/>
        <div>
        <Link to="/" style={{position:"relative",top:"90px",left:"30px",textDecoration:"none",fontStyle:"bold",fontSize:"25px",color:"white"}}>Go to login Page</Link>
        </div>
        </div>
    )
}
